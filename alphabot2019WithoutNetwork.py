    ...
    ##                    print('************************************************************')
                        ...
                        if len(rightTargets) >= 1 and len(leftTargets) >= 1:
                            ...
                            if rightCenter[0][0] > areaFactor * float(rightMaxArea[0][0]): ## We are looking at a target which is close to the center
                                ...
                                dist = CalcProperties(rightCenter, leftCenter)t = (95.841 * x ** -0.449)*12 #this is the formula to calc distance.  You will need to do this in excel for your camera
                                #print('Distance: ' + str(dist)) ### Put this back for testing
                                ...
                                dist = CalcProperties(rightCenter, leftCenter) (95.841 * x ** -0.449)*12 #this is the formula to calc distance.  You will need to do this in excel for your camera
                                #print('Distance: ' + str(dist)) ### Put this back for testing
