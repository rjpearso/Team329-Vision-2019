...
public class AutoRightHab2NearRocket extends CommandGroup {
  /**
   * Add your docs here.
   */
  public AutoRightHab2NearRocket() {
   ...
   addSequential(new StraightDistanceDriving(45, 0)); // Get clear of Hab1 maybe slow?
   addSequential(new TimerElapsing());
