...
public class AutoRightHab1FrontShip extends CommandGroup {
  /**
   * Add your docs here.
   */
  public AutoRightHab1FrontShip() {
    ...
    addSequential(new TimerElapsing());
    //Go back
    addSequential(new SlowStraightDistanceDriving(-175, -90));//-160,-90 for testing 
    addSequential(new TimerElapsing());
