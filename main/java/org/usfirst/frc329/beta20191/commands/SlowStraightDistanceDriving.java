...
public class SlowStraightDistanceDriving extends Command {
  //private static final double DISTANCE_MAX_ERROR = 6;
  private double d, currLoc, currabsVel, m, b, error, absError, pow, a;
  private static final double MAX_POWER = .4; //.45
  ...
  private static final double MIN_ERROR = 50; // start linear equation  was 20
  ...
  private static final double MAX_POWER_S = .29; //.25
  ...
  public SlowStraightDistanceDriving(double dist) {
    requires(Robot.sDrive);
    d = dist;
    a = NOT_AN_ANGLE; 
  }

  public SlowStraightDistanceDriving(double dist, double angle) {
    requires(Robot.sDrive);
    d = dist;
    a = angle;
  }
  ...
  protected void end() {
    ...
    System.out.println("SlowStraightDistanceDriving Done" + "  currLoc = " + currLoc);
  }
